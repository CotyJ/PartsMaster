            ...
            <div id="nav-dash-container" className="col-auto">
              <nav id="nav-bar" className="row navbar d-flex justify-content-between mt-0 pt-0 align-items-start">
                <ul className="navbar-nav">
                  ...
                  <li className="nav-item navbar-text "><NavLink className="nav-link px-4" to="/parts-table">Lookup</NavLink></li>
                  <li className="nav-item navbar-text "><NavLink className="nav-link px-4" to="/kb-checkin">Replenish</NavLink></li>
